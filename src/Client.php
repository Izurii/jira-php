...
use Jira\Resources\Organizations;
use Jira\Resources\Projects;
use Jira\Resources\Requests;
use Jira\Resources\ServiceDesks;
...
class Client
{
	...
	{
		return new Organizations(transporter: $this->transporter);
	}

	public function serviceDesks(): ServiceDesks
	{
		return new ServiceDesks(transporter: $this->transporter);
	}
}
